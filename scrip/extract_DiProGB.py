...
def read_index_file(filename):
    ...
    dna_res = list(dna_dict.items())
    rna_res = list(rna_dict.items())
    # for e in dna_res:
    #     print(e)
    # print(len(dna_res))
    # print(len(rna_res))
...
def combine_dna_dict(dna_dict, alphabet, write_file):
    ...
    with open(tri_dna_file, 'rb') as f:
        ...
        for _property, vals in list(dna_dict.items()):
...
def write_rna(rna_dict, filename):
    ...
    dinucle_prop_vals = {}
    for _property, vals in list(rna_dict.items()):
        for ind, val in enumerate(vals):
...
if __name__ == '__main__':
    ...
    dinucle_name, dinucle_vals = list(dna_dict.keys()), list(dna_dict.values())
    # print(dinucle_name)
